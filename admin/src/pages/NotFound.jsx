...
export default function NotFound() {
 ...
 <button onClick={() => window.history.back()} className="px-5 py-2.5 rounded-xl border border-white/10 text-white text-sm font-medium hover:bg-white/[0.04] transition-colors flex items-center gap-2">
 <ArrowLeft size={16} />
 Go Back
 </button>
