...
export default function NetworkStatus() {
 ...
 {!isOnline ? (
 <div className="flex items-center gap-3 bg-red-500/90 text-white px-5 py-3 rounded-full border border-red-400/30">
 <WifiOff size={16} />
 <p className="text-sm font-semibold tracking-wide">You are offline. Please check your internet connection.</p>
 </div>
 ) : (
 <div className="flex items-center gap-3 bg-emerald-500/90 text-white px-5 py-3 rounded-full border border-emerald-400/30 animate-pulse">
 <Wifi size={16} />
